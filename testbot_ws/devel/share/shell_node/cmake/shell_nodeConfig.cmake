...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'shell_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jimmy/github/MyRepo/testbot_ws/src/shell_node/${idir}'.  Ask the maintainer 'private <jj@gps-bot.com>' to fix it.")
    endif()
